-- Datos de la lista "homeBenefits"
...
-- Datos de la lista "featureBenefits"
INSERT INTO benefit (icon, title, description, color, isStrikethrough, section) VALUES
('CheckCircle', 'Todo Incluido', 'Los pagos mensuales incluyen todos nuestros servicios.', 'text-green-600', false, 'HOME'),
('DollarSign', 'Sin costo extra', 'No cobramos costos de licencias, actualizaciones ni mantenimiento.', 'text-yellow-600', true, 'HOME'),
('Unlock', 'Sin contratos', 'No pedimos un periodo mínimo de permanencia.', 'text-blue-600', false, 'HOME'),
('Clock', 'Ahorro de Tiempo', 'Automatiza tus procesos de facturación y ahorra horas cada mes.', 'text-purple-500', false, 'HOME'),
('XCircle', 'Sin ataduras', 'Puedes cancelar el servicio cuando quieras.', 'text-red-600', false, 'HOME');
